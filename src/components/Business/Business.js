          ...
          <div className="col-5">
            <div className="FB_logo">
              <small>
                ...
                <span className="fmFFGHM text-upper rv+rROO RGte4qL h18IWLb">
                  New
                </span>
              </small>
            </div>
            ...
            <div className="FB_list_ul">
              ...
              <a class="btn_bussiness" href="">
                Explore Fiverr Business
              </a>
            </div>
          </div>
          <div className="col-7 FB_right_img">
            <img src="./img/business-desktop-870-x1.png" alt="" />
          </div>
        </div>
      </div>
    </div>
