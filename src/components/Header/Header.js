      ...
      <nav className="navbar navbar-expand-md   ">
        ...
        >
          <ul className="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/start_selling?source=top_nav">
                Become a Seller
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/login?source=top_nav">
                Sign In
              </a>
            </li>
            <li class="nav-item join-btn">
              <a class="nav-link join-link" href="/join?source=top_nav">
                Join
              </a>
            </li>
          </ul>
