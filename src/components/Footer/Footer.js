        ...
        <div className="bottom">
          ...
          {/* <div className="icon-right">
            <ul>
              ...
              <li>
                <button className=" accessibility-button .default">
              ...
              <li>
                <section>
                  <button class="selection-trigger accessibility-button  currency-selection-trigger text-body-2 default">
                    US$ USD
                  </button>
                </section>
              </li>
